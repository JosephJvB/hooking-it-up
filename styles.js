...
const container = {margin: '5rem auto', maxWidth: '400px', display: 'flex', flexDirection: 'column'}
const title = {marginBottom: '2px', textAlign: 'center'}
const subtitle = {marginBottom: '1rem', textAlign: 'center'}
const button = {width: '-moz-max-Content', maxWidth: 'fit-content', padding: '0.5rem 1.2rem', fontWeight: '500', fontSize: '16px', margin: '2rem auto 2rem 15px', borderRadius: '5px', backgroundColor: 'rgb(120, 217, 110)'}
...
const hand = {margin: '2rem 0 2rem auto', fontSize: '28px'}
const submit = {display: 'flex', flexDirection: 'row'}
